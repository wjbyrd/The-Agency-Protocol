// =============================================
// THE AGENCY PROTOCOL — EXTERNAL QUESTION BANK
// Upgraded with dedicated Legendary and Legendary Boss pools plus rich question metadata.
// Keep this file beside the upgraded Agency Protocol HTML file in the GitHub Pages root.
// =============================================

window.objectiveLabels = {
  "LO19.1": "Insurance as a wealth-creating risk transfer",
  "LO19.2": "Adverse selection and hidden information before a transaction",
  "LO19.3": "Solutions to adverse selection through screening",
  "LO19.4": "Screening and signaling as responses to hidden information",
  "LO19.5": "Online markets, reputation systems, and adverse selection",
  "LO20.1": "Moral hazard and how it differs from adverse selection",
  "LO20.2": "Anticipating moral hazard after incentives change",
  "LO20.3": "Reducing moral hazard through monitoring and information",
  "LO20.4": "Shirking as a form of moral hazard",
  "LO20.5": "Moral hazard in lending and borrower incentives",
  "LO21.1": "Principal-agent relationships and incentive conflict",
  "LO21.2": "Information asymmetry, adverse selection, and moral hazard in agency problems",
  "LO21.3": "Agency costs, monitoring, bonding, residual loss, and incentive alignment",
  "LO21.4": "Centralization, decentralization, and decision rights",
  "LO21.5": "Gaming incentives and unintended behavioral responses",
  "LO21.6": "Diagnosing and controlling principal-agent conflicts",
  "LO22.1": "Parent-company goals and total firm profit",
  "LO22.2": "Transfer pricing and internal division incentives",
  "LO22.3": "Profit centers, cost centers, and performance evaluation",
  "LO22.4": "Functional units and specialization",
  "LO22.5": "Coordination across functional divisions",
  "LO22.6": "Multidivisional structure and division accountability",
  "LO22.7": "Budget games and managerial manipulation of targets"
};
...
window.questionBanks = {
  ...
  ,
    {
      "id": 4030,
      "sourceGame": "agencyProtocol",
      "q": "The Architect studies a hospital. Its board wants efficient patient outcomes, but the chief medical officer controls staffing and earns a larger bonus when the department grows. Which statement correctly diagnoses the relationship?",
      "options": [
    ...
    },
    {
      "id": 4031,
      "sourceGame": "agencyProtocol",
      "q": "The Architect reviews an investment fund. Investors bear losses, but the portfolio manager receives a large bonus for high annual returns and little penalty for later losses. What is the central agency risk?",
      "options": [
    ...
    },
    {
      "id": 4032,
      "sourceGame": "agencyProtocol",
      "q": "The Architect maps a loan across time. Before approval, the entrepreneur privately knows the project is unusually risky. After receiving funds, the entrepreneur switches to an even riskier project. Which classification is correct?",
      "options": [
    ...
    },
    {
      "id": 4033,
      "sourceGame": "agencyProtocol",
      "q": "The Architect evaluates a regional manager who privately reports the demand forecast and later chooses selling effort that headquarters cannot observe. Which information problem does headquarters face?",
      "options": [
    ...
    },
    {
      "id": 4034,
      "sourceGame": "agencyProtocol",
      "q": "The Architect finds that service agents are paid for closing tickets. They mark difficult cases resolved, knowing many will reopen later. Which redesign best attacks the gaming problem?",
      "options": [
    ...
    },
    {
      "id": 4035,
      "sourceGame": "agencyProtocol",
      "q": "The Architect groups all engineers under one engineering leader and all purchasing specialists under one purchasing leader. Which benefit most directly follows from this functional design?",
      "options": [
    ...
    },
    {
      "id": 4036,
      "sourceGame": "agencyProtocol",
      "q": "The Architect must choose between a functional and multidivisional structure. When is the functional structure generally more attractive?",
      "options": [
    ...
    },
    {
      "id": 4037,
      "sourceGame": "agencyProtocol",
      "q": "The Architect sees marketing rewarded for orders while operations is rewarded for low unit cost. Marketing sells customized rush orders that raise production costs and delay delivery. What is the strongest coordination fix?",
      "options": [
    ...
    },
    {
      "id": 4038,
      "sourceGame": "agencyProtocol",
      "q": "The Architect discovers that next year's sales target is set mechanically from this year's reported sales. Managers delay December orders into January so the next target begins from a lower base. What are they doing?",
      "options": [
  ...
  "hard": [
    ...
    },
    {
      "id": 209,
      "sourceGame": "agencyProtocol",
      "q": "A car insurer offers a discount to drivers who agree to install a device that records driving behavior before renewal pricing. What is the insurer mainly using?",
      "options": [
      ...
      "repairSkill": "screening_hidden_type",
      "commonError": "confuses_screening_by_the_less_informed_party_with_signaling_by_the_informed_party",
      "feedback": "The insurer uses the device to gather information and sort drivers by risk."
    },
    {
      "id": 210,
      "sourceGame": "agencyProtocol",
    ...
    },
    {
      "id": 246,
      "sourceGame": "agencyProtocol",
      "q": "A sales agent is paid only for new accounts, so they sign low-quality customers who later default. What does this show?",
      "options": [
        "Incentives can create adverse selection for the firm by attracting or accepting bad matches",
      ...
      "repairSkill": "principal_agent_conflict",
      "commonError": "assumes_principal_and_agent_objectives_are_automatically_aligned",
      "feedback": "The agent's incentive pushes them to bring in customers who may be bad for the principal."
    },
    {
      "id": 247,
      "sourceGame": "agencyProtocol",
  ...
  "legendaryBoss": [
    ...
    },
    {
      "id": 9109,
      "sourceGame": "agencyProtocol",
      "q": "The Architect watches managers hit every metric while customers leave, quality falls, and long-term value declines. What went wrong?",
      "options": [
    ...
    },
    {
      "id": 9124,
      "sourceGame": "agencyProtocol",
      "q": "The Custodian sees hidden worker ability before hiring, hidden worker effort after hiring, and a bonus that rewards the wrong output. What is the cleanest diagnosis?",
      "options": [
...
// Backward-compatible aliases for older engine references.
window.easyConceptPools = window.microSkillRepairPools;
window.mediumConceptPools = window.microSkillBridgePools;

// Quick validation in the browser console. This is not the engine. It is a guardrail.
(function validateAgencyBank(){
  const banks = window.questionBanks || {};
  const ids = [];
  Object.values(banks).forEach(pool => {
    if(Array.isArray(pool)) pool.forEach(q => ids.push(q.id));
  });
  const duplicateIds = ids.filter((id, index) => ids.indexOf(id) !== index);
  if(duplicateIds.length){
    console.warn("Agency Protocol duplicate question IDs detected:", [...new Set(duplicateIds)]);
  }
  const bossObjectiveCoverage = {};
  ["easyBoss", "mediumBoss", "finalBoss"].forEach(poolName => {
    const counts = {};
    (banks[poolName] || []).forEach(q => {
      counts[q.objective] = (counts[q.objective] || 0) + 1;
    });
    bossObjectiveCoverage[poolName] = counts;
    const undersized = Object.entries(counts).filter(([, count]) => count < 3);
    if(undersized.length){
      console.warn(`Agency Protocol ${poolName} objective groups below three questions:`, Object.fromEntries(undersized));
    }
  });
  console.log("Agency Protocol question bank loaded", {
